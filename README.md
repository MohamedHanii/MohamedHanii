...
- Applied Machine Learning & AI Infrastructure
- Backend Architecture & Distributed Systems
- API Design & Background Processing
...
**[Chat-App](https://github.com/MohamedHanii/Chat-App)** — Real-time chat application built with Ruby and ActionCable  
**[Book-Social-Network](https://github.com/MohamedHanii/Book-Social-Network)** — Social platform for book lovers built with Java  
**[e-commerce](https://github.com/MohamedHanii/e-commerce)** — Full e-commerce platform built with Java  
**[YelpCamp](https://github.com/MohamedHanii/YelpCamp)** — Campground discovery and review web app built with JavaScript  
**[Dictionary-Search](https://github.com/MohamedHanii/Dictionary-Search)** — Red-black tree algorithm for efficient dictionary search in Python  
